...
How do you visit a place you never been before by foot?
You may bring a printed map in your bag, or bookmark it in your cell phone not to lose your way till reaching your destination.
Or you may finally open Google Map to know direction at a station just after you get off a train.
In any case, you will drop your gaze to the map many time not to lose your way.
This is a typical guidance scenario for pedestrians.

The point described before is that you need to pay attention to looking at the map. In terms of navigation, the direction to where you should go is given explicitly, in other words, consciously.
This means that, as several study have pointed out {\bf **reference**}, the typical navigation sequence gives mental load to you. How can we get rid of the load? This question is the reason why these previous studies propose subconscious navigating using sensory illusion.

Promoting the idea, here is an ultimate guidance scenario: even though you don't need to remember the route nor to look at any map in the way, you can come to the place where you never been before; in addition, you never notice when and how the guidance system supports you. You can arrive on foot without any conscious annotation as if you walk the usual route; though you don't know the actual route. It looks as if you know the entire route; however, any conscious nor verbal information is given to you. This is a kind of future scenario like magic.

How can human and computer interact with each other in this case? Needless to say, to direct and physical walking control is difficult to apply for daily use, since it often requires powerful actuator to move a heavy part of our body. On the other hand, in terms of gait has a control cycle including sensory input and movement output, we can say that sensory feedback can control gait movement described before. To give sensory illusion is relatively practical way to control the gait subconsciously; because our body has automatic response to the sensory input; as well as the way of sensory input does not need high-power physical actuation to our body. Such response is called "postural reflex," and occurs subconsciously. Therefore, alternative illusion sensory feedback is useful to induce user's behavior. In terms of pedestrian's directional guidance, illusion sensory input can induce postural sway to the one side; then the sway results gait route change. 



%%
social requirement and impact
	ultimate goal of this research : if when you are going to lose your way till the.
	as if you know all road.
	support before trouble with anticipation
	subconsciousness 
	implicit vs explict
	cyclic delay accurate challenge
 	a kind of brain machine interface -> difficulty of measureing brain activity under dynamic movement 
	behavior is brain generated signal as well 
	planning and movement going through under consciousness
gait guidance
	impicit gait gaidance : phyilosophy
